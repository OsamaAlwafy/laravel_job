  ...
  <div class="grid-container">
    ...
    <div class="item-grid catigroy">
      ...
      <div class="container-catigroy-box">
        ...
        if (isset($type) && isset($params) && $type == 'catigory') {
        ...
        ?>
            ...
            <div class="catigroy-box">
              <a href=<?php echo "/category/".$catigory->id ?> ?>> <img src=<?php echo 'images/' . $catigory->image ?>></a>
              <p><?php echo $catigory->name; ?></p>
            </div>
        <?php }
        } ?>
        <!-- <div class="catigroy-box">
    ...
    <div class="item-grid current-display">
      ...
      <div class="container-book-offer">
        ...
        if (isset($type) && isset($params) && $type == 'catigory') {
          foreach ($params['offer'] as $offer) {


        ?>
            <div class="book-offer">
              <a href="/details"> <img src=<?php echo 'images/' . $offer->image ?>></a>
              <p> <img src="images/svgexport-56.svg">
                <span class="type-book">
                  <?php echo $offer->format; ?>
                </span>
              </p>
              <p class="title"><?php echo $offer->name_book; ?></p>
              <span class="price"><?php echo $offer->price; ?></span>
              <p> العرض سينتهي بعد :</p>
              <p class="offer" data-offer="jan 20, 2022 00:00:00">
                <?php echo $offer->end_date; ?>

              </p>
              <div class="icon-under-book">
                <a href=<?php echo "card/" . $offer->id ?>> <img src="images/svgexport-2.svg"> </a>
                <a href=<?php echo "card/" . $offer->id ?>> <img src="images/svgexport-21.svg"> </a>
                <a href=<?php echo "card/" . $offer->id ?>><img src="images/svgexport-56.svg"></a>
    ...
    foreach ($params['nameCat'] as $nameCat) {
    
    ?>
      <div class="item-grid current-display">
        <p> <?php echo $nameCat['name'] . " loop"; ?> </p>
        <div class="container-book-offer">
          <?php

          foreach ($params[$nameCat['name']] as $offer) {
          ...
          ?>
            <div class="book-offer">
              ...
              <p class="title"><?php echo $offer['title']; ?></p>
              <span class="price"><?php echo $offer['price']; ?></span>
              ...
              <!-- <p class="offer" data-offer="jan 20, 2022 00:00:00">
               ...
               <div class="icon-under-book">
                <a href=<?php echo "card/din/" . $offer['id'] ?>> <img src="images/svgexport-2.svg"> </a>
                <a href=<?php echo "card/din/" . $offer['id']  ?>> <img src="images/svgexport-21.svg"> </a>
                <a href=<?php echo "card/din/" . $offer['id'] ?>><img src="images/svgexport-56.svg"></a>
