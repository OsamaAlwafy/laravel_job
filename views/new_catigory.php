            ...
            <form class="card-body  border-0" action="/save_catigory" method="POST" id="dropzone-basic" enctype="multipart/form-data">
              ...
              <div class="row g-3">
                <div class="col-md-6 mb-1">
                  <label class="form-label" for="multicol-username">Catigory Name</label>
              ...
              <div class="col-12">
                ...
                <div class="card mb-4">
                  ...
                  <div id="imageupload" class="card-body">
                    ...
                    <!-- <div id="fallback" class="fallback" style="display:block !important; visibility: visible !important;; opacity: 1 !important;"> -->
