    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <!-- Content -->
          <div class="card mb-4 ">
            <h5 class="card-header">Enter Admin Details</h5>
            <form class="card-body  border-0" action="/save_admin" method="POST" id="dropzone-basic" enctype="multipart/form-data">

              <div class="row g-3">
                <div class="col-md-6 mb-1">
                  <label class="form-label" for="multicol-username">Admin Name</label>
                  <input name="name" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
                </div>
                <div class="col-md-6 mb-1">
                  <label class="form-label" for="multicol-username">Admin Email</label>
                ...
                <div class="col-md-6 mb-1">
                  <label class="form-label" for="multicol-username">Admin Password </label>
                  <input name="pass" type="password" id="multicol-username" class="form-control" placeholder="john.doe" />
                </div>
                ...
                <div class="col-md-6 mb-1">
                  <div class="form-password-toggle">
                    <label class="form-label" for="multicol-confirm-password">Admin Activation</label>
