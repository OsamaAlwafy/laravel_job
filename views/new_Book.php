          ...
          <div class="card mb-4 ">
            ...
            <form class="card-body  border-0" action="/save_book" method="POST" id="dropzone-basic" enctype="multipart/form-data">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6 mb-1">
                  <label for="price" class=" col-form-label">Book Price</label>
                  <input class="form-control" id="price" name="price" type="number" value="18" />
                </div>
                ...
                <div class="col-md-6 mb-4">
                  <label for="select2Basic" class="form-label">Author</label>
                  <select id="select2Basic" name="author_id" class="select2 form-select form-select-lg" data-allow-clear="true">
                ...
                <div class="col-md-6 mb-4">
                  <label for="select2Basic" class="form-label">Publisher</label>
                ...
                <div class="col-12">
                  ...
                  <div class="col-md-6">
                    <div class="form-password-toggle">
                      <label class="form-label" for="multicol-confirm-password">Catigory Activation</label>
