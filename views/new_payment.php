            ...
            <form class="card-body  border-0" action="/save_payment" method="POST" id="dropzone-basic" enctype="multipart/form-data">
              ...
              <div class="row g-3">
                <div class="col-md-6 mb-1">
                  <label class="form-label" for="multicol-username">Payment Name</label>
                  <input name="name" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
                </div>
                
                <div class="col-md-6 mb-1">
                  <div class="form-password-toggle">
                    <label class="form-label" for="multicol-confirm-password">Payment Activation</label>
                ...
                <div class="col-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <div id="imageupload" class="card-body">
                      <label class="form-label" for="">Payment Image</label>
