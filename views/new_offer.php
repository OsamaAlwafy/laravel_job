            ...
            <form class="card-body  border-0" action="/save_offer" method="POST" id="dropzone-basic" enctype="multipart/form-data">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6 mb-4">
                  <label for="select2Basic" class="form-label">Books</label>
                  <select id="select2Basic" name="book_id" class="select2 form-select form-select-lg" data-allow-clear="true">
                ...
                <div class="col-md-6 mb-1">
                  <div class="form-password-toggle">
                    <label class="form-label" for="multicol-confirm-password">Discount Activation</label>
                ...
                <!-- <div class="form-check form-check-primary mt-3">
                  <input class="form-check-input" name="" type="checkbox" value="" id="customCheckPrimary" checked />
