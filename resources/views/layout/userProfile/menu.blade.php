...
<ul class="menu-inner py-1">
    ...
    <li class="menu-item">
       <a href="{{route('show_skill')}}" class="menu-link ">
            <i class="menu-icon tf-icons bx bx-home-circle"></i>
            <div data-i18n="  المهارات " ></div>
        </a>
    ...
    <li class="menu-item">
      <a href="{{route('show_qualifications')}}" class="menu-link ">
          <i class="menu-icon tf-icons bx bx-home-circle"></i>
          <div data-i18n="  الموهلات " > الموهلات</div>
      </a>
  
  </li>
  <li class="menu-item">
    <a href="{{route('show_pre_work')}}" class="menu-link ">
        <i class="menu-icon tf-icons bx bx-home-circle"></i>
        <div data-i18n="  المشاريع " ></div>
    </a>

</li>
<li class="menu-item">
  <a href="{{route('show_experience')}}" class="menu-link ">
      <i class="menu-icon tf-icons bx bx-home-circle"></i>
      <div data-i18n="  الخبرات " ></div>
  </a>
