        ...
        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
          ...
          <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="email" name="full_name" placeholder="Enter your email or username" autofocus>
              @error('full_name')
              <span class="alert alert-danger">{{ $message }}</span>
          @enderror
            </div>
            <input type='hidden' name='role' vlaue='client'>

            <div class="mb-3">
              <label for="email" class="form-label">Email</label>
              <input type="text" class="form-control" id="email" name="u_email" placeholder="Enter your email or username" autofocus>
              @error('u_email')
              <span class="alert alert-danger">{{ $message }}</span>
          @enderror
            </div>
